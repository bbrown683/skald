...
public class InstructionGenerator {
    ...
    public void addVariableAsField(String variableName, Type type, int accessFlags, String className) {
    ...
    public void addVariableAsLocalVariable(String variableName, Type variableType, int accessFlags) {
